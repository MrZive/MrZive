...
@TableName("退款单-合作项目--纹绣")
public class MyRefundDetailOfCooperationWx {
	...
	public void fromSuper(ProjectCooperationWxDetailConsumption projectCooperationWxDetailConsumptionById,RefundDetail detail){
		this.id = detail.getId();
		this.consumptionId = projectCooperationWxDetailConsumptionById.getConsumptionId();
		this.consumptionProjectId = projectCooperationWxDetailConsumptionById.getConsumptionProjectId();
