 ...
 *
 */
public class BiDayDao extends BaseDao{
...
//		System.out.println(employeeEarnList.size());
		...
		JSONArray itemInfoReturn = getItemInfoForReturn(buyRetrunOrderDetail,monthOfTarget);
		...
		JSONArray itemInfoNewReturn = getItemInfoForNewReturn(buyNewRetrunOrderDetail,monthOfTarget);
		...
		JSONArray itemInfoWxProject = getItemInfoForWxProject(buyProjectWxOrderDetail,monthOfTarget);
		...
		JSONArray itemInfoWxReturn = getItemInfoForWxReturn(buyRetrunWxOrderDetail,monthOfTarget);
	...
	static JSONArray getItemInfoForProject(List<ProjectBuy> buyProjectOrderDetail, Set<String> monthOfTarget){
	...
	static JSONArray getItemInfoForProduct(List<ProductBuy> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (ProductBuy projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
	...
	static JSONArray getItemInfoForSet(List<NewSetBuy> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (NewSetBuy projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
...
//				point += projectBuy.getPoint();
	...
	static JSONArray getItemInfoForCoo(List<CooperationBuy> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (CooperationBuy projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
	...
	static JSONArray getItemInfoForRefund(List<RefundOrderDetail> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (RefundOrderDetail projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
...
//			point += projectBuy.getPoint();
	...
	static JSONArray getItemInfoForReturn(List<ReturnOrderDetail> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (ReturnOrderDetail projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
...
//			point += projectBuy.getPoint();
	...
	static JSONArray getItemInfoForNewReturn(List<ReturnOrderDetail> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (ReturnOrderDetail projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
	...
	static JSONArray getItemInfoForWxProject(List<ProjectBuy> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (ProjectBuy projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
...
//			point += projectBuy.getPoint();
	...
	static JSONArray getItemInfoForWxReturn(List<ReturnOrderDetail> buyProjectOrderDetail, Set<String> monthOfTarget){
		JSONArray json = new JSONArray();
		for (ReturnOrderDetail projectBuy : buyProjectOrderDetail) {
			if(monthOfTarget.size()>0 && !monthOfTarget.contains(projectBuy.getShopId())){
				continue;
