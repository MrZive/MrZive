...
public class ZhaoMeiAddMemberTest2 extends BaseKangWangDao{

public static void main(String[] args) throws IOException, ParseException {
		
		File file = new File("D:\\公司数据\\操作数据\\找美网\\会员 - 新增.xls");
		...
		for(int i = 1; i < excelSheet.getRows().size();i++){
			...
			String lastServiceTime = excelCells.get(10).getValue()==null?null:excelCells.get(10).getValue().toString();
			
			String birthday = excelCells.get(11).getValue()==null?"":excelCells.get(11).getValue().toString();
