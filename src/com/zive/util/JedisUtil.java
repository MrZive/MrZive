...
public class JedisUtil {
    ...
    // Redis服务器IP
    private static String ADDR = "192.168.0.30";
    // Redis的端口号
    private static int PORT = 6379;
    // 访问密码
    private static String AUTH = "123";
    //geo功能的key
    private static String GEO_KEY = "shop.geo";
    ...
    public static void main(String[] args) {
    	String my = "zive";
    	GeoCoordinate coordinate= new GeoCoordinate(113.299590D, 22.9680);
    	String shop = "总部店";
    	GeoCoordinate coordinate2= new GeoCoordinate(113.299542D, 22.9695D);
		JedisUtil.geoadd("geo", coordinate, my);
//		JedisUtil.geoadd("geo", coordinate2, shop);
	}
