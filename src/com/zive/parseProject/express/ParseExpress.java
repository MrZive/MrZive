package com.zive.parseProject.express;
...
public class ParseExpress extends BaseDao{
	...
	public static void main(String[] args) throws IOException {
		...
		for (ProductDetailConsumption detail : list) {
			if(detail.getLeftNumber()!=null && detail.getLeftNumber() > 0){
				...
				change.setProductId("c38329be-ee39-4b30-b35f-b7f6b034cc2d");
		...
		for (ProductDetailConsumption detail : list) {
			if(detail.getLeftNumber()!=null && detail.getLeftNumber() > 0){
				...
				ProductDetailConsumption change = new ProductDetailConsumption();
				change.setId(detail.getId());
//				change.setProductId("c38329be-ee39-4b30-b35f-b7f6b034cc2d");//老系统
				change.setProductId("87cf7cfa-b823-464d-b13c-f1d51b0b340c");//新系统
